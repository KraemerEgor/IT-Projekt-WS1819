...
public interface EditorAdministration extends RemoteService {
	 ...
	 * @return einen Vector, der alle Userobjekte enthÃ¤lt, die vom Mapper aus der Datenbank Ã¼bergeben werden
	 ...
	 * übergeben wird
	 * @return einen Vektor, der alle Posts enthÃ¤lt, die vom Mapper zurückgegeben werden
	 * @throws IllegalArgumentException
	 */
	 ...
	 * @return ein Vektor-Objekt, das alle Kommentare enthÃ¤lt
	 * @throws IllegalArgumentException
	 */
